...
const _imports_1 = "" + buildAssetsURL("Logout.rBdhgkO0.png");
const ToPayIcon = "" + buildAssetsURL("ToPay.DexCDMUW.png");
const NotTraveledIcon = "" + buildAssetsURL("NotTraveled.D49dRuKx.png");
const RefundIcon = "" + buildAssetsURL("Refund.B578csSl.png");
const PasswordIcon = "" + buildAssetsURL("Password.0HOPv-w0.png");
const ContactIcon = "" + buildAssetsURL("Contact.CWgz6Aov.png");
const ReviewIcon = "" + buildAssetsURL("Review.CaQzWClN.png");
const passengerIcon = "" + buildAssetsURL("passengericon.COiQugWc.png");
const orderIcon = "" + buildAssetsURL("orderIcon.BS_hO_AY.png");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-green-400" }, _attrs))}><div class="flex py-12 items-center"><div class="px-4 flex-none">`);
      ...
      _push(`</div><div class="flex flex-col flex-1"><p>${ssrInterpolate(unref(userStore).user_name || _ctx.$t("profile.nickname"))}</p><div class="flex"></div></div></div><div class="bg-gray-100 rounded-t-3xl shadow h-screen"><div class="flex p-4 justify-between"><!--[-->`);
      ssrRenderList(BookingStatus, (status) => {
        _push(`<button${ssrRenderAttr(":key", status.name)} class="flex flex-col items-center mx-auto text-sm"><img${ssrRenderAttr("src", status.icon)}${ssrRenderAttr("alt", status.name)} class="w-6 h-6"> ${ssrInterpolate(_ctx.$t(`bookingStatus.${status.name}`))}</button>`);
      });
      _push(`<!--]--></div><div class="flex flex-col p-1 bg-white rounded-lg mx-4"><!--[-->`);
      ssrRenderList(ProfileSettings, (settings) => {
        _push(`<div class="border-b flex p-2 items-center"${ssrRenderAttr(":key", settings.name)}><div class="flex flex-1"><div class="flex flex-1 text-sm"><img${ssrRenderAttr("src", settings.icon)}${ssrRenderAttr("alt", settings.name)} class="w-5 h-5 mr-2"> ${ssrInterpolate(_ctx.$t("profileSettings." + settings.name))}</div><img${ssrRenderAttr("src", _imports_0)} alt="More" class="w-4 h-4"></div></div>`);
      });
      _push(`<!--]--><div><div class="flex p-3 items-center"><div class="flex flex-1 text-sm -400 justify-center"><img${ssrRenderAttr("src", _imports_1)} alt="Logout" class="w-5 h-5 mr-2"><p>${ssrInterpolate(_ctx.$t("profile.logout"))}</p></div></div></div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=profile-BVS7voNf.mjs.map

  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(pages, (page) => {
        ...
        _push(`<span class="${ssrRenderClass(selectedPage.value === page.name ? "text-green-500 font-bold" : "text-gray-500")}">${ssrInterpolate(_ctx.$t(`footer.${page.name}`))}</span></button>`);
      });
      _push(`<!--]--></div></footer>`);
    };
  }
...
//# sourceMappingURL=default-BQQgmlrd.mjs.map

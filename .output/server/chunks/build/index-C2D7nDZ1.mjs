  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(options, (option) => {
        _push(`<div class="${ssrRenderClass([selectedoption.value === option.name ? "text-green-500 font-bold bg-teal-50" : "text-gray-500 hover:text-green-400", "flex flex-col py-4 items-center text-sm shadow-sm px-4 cursor-pointer transition-all duration-200"])}">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: option.icon,
          class: "h-6 w-6"
        }, null, _parent));
...
//# sourceMappingURL=index-C2D7nDZ1.mjs.map

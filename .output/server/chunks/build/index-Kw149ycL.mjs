...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseEqual, ssrLooseContain, ssrRenderClass } from 'vue/server-renderer';
import { b as useI18n, _ as _export_sfc, u as useLocalePath, n as navigateTo } from './server.mjs';
...
import { l as localeValues, a as localeValues$1, b as api$1, C as ConfigProvider, S as Space, D as DatePicker$1, T as TimePicker$1, B as Button, c as api } from './zh_TW-DxTaLLT_.mjs';
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative" }, _attrs))}><button class="flex items-center border-2 border-white rounded-3xl text-white px-2">`);
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "py-4 border-b bg-green-400 flex items-center" }, _attrs))}><div>`);
  _push(ssrRenderComponent(_component_LangSwitcher, { class: "pl-4" }, null, _parent));
  _push(`</div><h1 class="absolute left-1/2 transform -translate-x-1/2 text-xl font-bold capitalize">${ssrInterpolate(_ctx.$t("title"))}</h1></header>`);
}
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="flex-col p-4"><div class="flex justify-around"><div class="flex">`);
      _push(ssrRenderComponent(_component_Icon, {
      ...
      _push(ssrRenderComponent(_component_Icon, {
        ...
        class: "mx-auto bg-yellow-600 w-7 h-7 cursor-pointer",
        onClick: swapText
      }, null, _parent));
      if (isSwapped.value) {
      ...
      if (isSwapped.value) {
        ...
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:tickets",
          class: "bg-green-300 w-6 h-6"
        }, null, _parent));
        _push(`<p class="text-green-300">${ssrInterpolate(_ctx.$t("Booking.flightNumber"))}</p></div><div class="border rounded-lg"><input type="text"${ssrRenderAttr("placeholder", _ctx.$t("Booking.required"))}${ssrRenderAttr("value", flightNumber.value)} class="flex-1 px-2 py-1 w-full bg-white rounded-lg focus:outline-none text-sm"></div></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (isSwapped.value) {
        _push(`<p class="text-green-300">${ssrInterpolate(_ctx.$t("Booking.arrivalAtAirportTime"))}</p>`);
      } else {
        _push(`<p class="text-green-300">${ssrInterpolate(_ctx.$t("Booking.arrivalPortTime"))}</p>`);
      }
      _push(`</div></div>`);
      ...
      _push(`<p class="text-green-300">${ssrInterpolate(isSwapped.value ? _ctx.$t("Booking.ferryTime") : _ctx.$t("Booking.flightTime"))}</p></div><div>`);
      if (isSwapped.value) {
        _push(ssrRenderComponent(_component_a_config_provider, { locale: unref(antLocale) }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      _push(`<p class="text-green-300">${ssrInterpolate(_ctx.$t("Booking.shuttleBusTime"))}</p></div>`);
      _push(ssrRenderComponent(_component_a_config_provider, { locale: unref(antLocale) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex pt-2 pl-4 space-x-4"${_scopeId}>`);
      ...
      _push(`</button><p class="px-2 flex text-sm">${ssrInterpolate(counts.value.adult)}</p><button>`);
      ...
      _push(ssrRenderComponent(_component_Icon, { name: "i-mdi-minus-circle-outline" }, null, _parent));
      _push(`</button><p class="px-2 text-sm">${ssrInterpolate(counts.value.child)}</p><button>`);
      _push(ssrRenderComponent(_component_Icon, { name: "i-material-symbols-add-circle-outline" }, null, _parent));
      ...
      _push(ssrRenderComponent(_component_a_button, {
        ...
        class: "w-2/3 rounded-lg bg-green-500 text-white"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_PopUpRules = __nuxt_component_6;
      const _component_a_button = Button;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex-col p-4" }, _attrs))}><div><p class="border-l-4 my-3 border-orange-400 text-justify pl-2">${ssrInterpolate(_ctx.$t("Booking.outward"))}</p></div><div class="flex justify-around"><div class="flex">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "i-material-symbols-directions-car",
        class: "bg-gray-500 w-6 h-6"
      }, null, _parent));
      ...
      _push(ssrRenderComponent(_component_Icon, {
        name: "i-hugeicons-exchange-01",
        class: "mx-auto bg-green-600 w-7 h-7",
        onClick: swapText
      }, null, _parent));
      ...
      _push(`<div class="border-b-2 py-3"></div><p class="border-l-4 my-3 border-orange-400 text-justify pl-2">${ssrInterpolate(_ctx.$t("Booking.return"))}</p><div class="flex justify-around"><div class="flex">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "i-material-symbols-directions-car",
        class: "bg-gray-500 w-6 h-6"
      }, null, _parent));
      ...
      _push(`<p class="text-green-300">${ssrInterpolate(isSwapped.value ? _ctx.$t("Booking.flightTime") : _ctx.$t("Booking.ferryTime"))}</p></div><div>`);
      if (isSwapped.value) {
        _push(ssrRenderComponent(_component_a_config_provider, { locale: unref(antLocale) }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      _push(`<div class="flex pl-6 pt-2 justify-evenly content-center"><div class="flex flex-1"><p class="flex-1">${ssrInterpolate(_ctx.$t("Booking.adultTicket"))}</p><div class="flex-1 flex"><button>`);
      _push(ssrRenderComponent(_component_Icon, { name: "i-mdi-minus-circle-outline" }, null, _parent));
      _push(`</button><p class="px-2">${ssrInterpolate(counts.value.adult)}</p><button>`);
      _push(ssrRenderComponent(_component_Icon, { name: "i-material-symbols-add-circle-outline" }, null, _parent));
      _push(`</button></div></div></div><div class="flex pl-6 pt-2 justify-evenly content-center"><div class="flex flex-1"><p class="flex-1">${ssrInterpolate(_ctx.$t("Booking.childTicket"))}</p><div class="flex-1 flex"><button>`);
      _push(ssrRenderComponent(_component_Icon, { name: "i-mdi-minus-circle-outline" }, null, _parent));
      _push(`</button><p class="px-2">${ssrInterpolate(counts.value.child)}</p><button>`);
      _push(ssrRenderComponent(_component_Icon, { name: "i-material-symbols-add-circle-outline" }, null, _parent));
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="flex flex-col pb-16"><div class="shadow mt-6 mx-10 rounded-lg bg-gray-50"><div class="flex"><div class="${ssrRenderClass([{ "bg-green-300 rounded-tr-lg": _ctx.activeTab === 2 }, "flex-1 flex justify-center rounded-tr-lg"])}"><button class="${ssrRenderClass({ " text-green-300 font-bold": _ctx.activeTab === 1 })}">${ssrInterpolate(_ctx.$t("HomePage.oneWay"))}</button></div><div class="${ssrRenderClass([{ "bg-green-300 rounded-tr-lg": _ctx.activeTab === 1 }, "flex-1 flex justify-center rounded-tr-lg"])}"><button class="${ssrRenderClass({ " text-green-300 font-bold": _ctx.activeTab === 2 })}">${ssrInterpolate(_ctx.$t("HomePage.roundTrip"))}</button></div></div>`);
  if (_ctx.activeTab === 1) {
    _push(`<div>`);
...
//# sourceMappingURL=index-Kw149ycL.mjs.map

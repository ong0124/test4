...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div><h1 class="absolute left-1/2 transform -translate-x-1/2 text-xl font-bold capitalize">${ssrInterpolate(_ctx.$t("boardingpointPage.title"))}</h1></header><p class="text-center text-lg pt-2">${ssrInterpolate(_ctx.$t("boardingpointPage.information"))}</p><img${ssrRenderAttr("src", _imports_0)} alt="boardingpointpng" class="rounded-lg pl-4 pr-4 pb-4"><p class="text-center text-lg">${ssrInterpolate(_ctx.$t("boardingpointPage.flowchart"))}</p><img${ssrRenderAttr("src", _imports_1)} alt="flowchartpng" class="rounded-lg pl-4 pr-4 pb-16"><!--]-->`);
}
...
//# sourceMappingURL=boardingpoint-BKTygXOw.mjs.map

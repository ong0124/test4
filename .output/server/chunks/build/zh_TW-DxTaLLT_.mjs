...
import { inject, ref, h, getCurrentInstance, nextTick, reactive, defineComponent, createVNode, computed, provide, shallowRef, Transition, watch, watchEffect, Teleport, TransitionGroup, render, Fragment, Text, toRef, toRaw, unref, useAttrs, createTextVNode, getCurrentScope, onScopeDispose, onMounted } from 'vue';
import { u as useConfigInject, c as classNames, k as flattenChildren, s as objectType, r as useToken, i as initDefaultProps, C as useInjectDisabled, l as localeValues$2, j as warning$1, h as withInstall, D as getTransitionGroupProps, E as Portal$1, F as useConfigContextInject, G as configProviderProps, H as defaultIconPrefixCls, I as createTheme, J as seedToken, L as useConfigContextProvider, M as useProvideGlobalForm, N as useProviderSize, O as useProviderDisabled, Q as LocaleReceiver, t as isPresetColor, R as isPresetStatusColor, f as filterEmpty, S as warningOnce, n as genComponentStyleHook, P as PropTypes, U as tuple$1, V as booleanType, W as eventType, w as wrapperRaf, e as cloneElement, X as getMotion$1, Y as renderHelper, Z as useStyleRegister, _ as defaultConfig, $ as renderEmpty, a0 as DesignTokenProvider, o as omit, m as findDOMNode, a1 as isVisible, T as Trigger, a2 as someType, a3 as functionType, a4 as stringType, a5 as arrayType, a6 as useLocaleReceiver, v as merge, a7 as noteOnce, a8 as resetIcon, a9 as locale$8, aa as genFocusStyle, y as resetComponent, B as roundedArrow, ab as textEllipsis, K as Keyframe, ac as capitalize, z as genPresetColor, x as initMotion, ad as wrapPromiseFn } from './colors-pnNxEzJR.mjs';
...
import { D, Y, W, M as MS, Q, a as M, F as FORMAT_DEFAULT, d as dayjs } from '../_/index.mjs';
...
var getLocalePart = function getLocalePart(name) {
  var part = locale$7[name];
  return part && (part.indexOf ? part : part.s.concat(part.f));
};

var meridiemMatch = function meridiemMatch(input, isLowerCase) {
  var isAfternoon;
  var _locale = locale$7,
...
function makeParser(format) {
  format = u(format, locale$7 && locale$7.formats);
...
const useStyle$7 = genComponentStyleHook("Space", (token) => [genSpaceStyle(token), genSpaceCompactStyle(token)]);
...
const useStyle$6 = genComponentStyleHook("Wave", (token) => [genWaveStyle(token)]);
...
const useStyle$5 = genComponentStyleHook("Button", (token) => {
  const {
    controlTmpOutline,
...
function useResizeObserver(target, callback) {
  ...
  } = options, observerOptions = __rest$7(options, ["window"]);
  let observer;
...
const useStyle$4 = genComponentStyleHook("DatePicker", (token) => {
...
Notification$1.newInstance = function newNotificationInstance(properties, callback) {
  const _a = properties || {}, {
    ...
    useStyle: useStyle2
  } = _a, props = __rest$6(_a, ["name", "getContainer", "appContext", "prefixCls", "rootPrefixCls", "transitionName", "hasTransitionName", "useStyle"]);
  ...
  function getPicker(picker, displayName) {
    ...
    return defineComponent({
      ...
      setup(_props, _ref) {
        ...
        const [contextLocale] = useLocaleReceiver("DatePicker", locale$8);
...
const Space = defineComponent({
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode("div", _objectSpread$g(_objectSpread$g({}, attrs), {}, {
...
function createTimePicker(generateConfig2) {
  const DatePicker2 = generatePicker(generateConfig2, _extends(_extends({}, timePickerProps()), {
    order: {
      type: Boolean,
      default: true
    }
  ...
  const TimePicker2 = defineComponent({
    ...
    setup(p, _ref) {
      ...
      return () => {
        ...
        return createVNode(InternalTimePicker, _objectSpread$g(_objectSpread$g(_objectSpread$g({}, attrs), omit(props, ["onUpdate:value", "onUpdate:open"])), {}, {
          "id": id,
  ...
  const TimeRangePicker2 = defineComponent({
    ...
    setup(p, _ref2) {
      ...
      return () => {
        ...
        return createVNode(InternalRangePicker, _objectSpread$g(_objectSpread$g(_objectSpread$g({}, attrs), omit(props, ["onUpdate:open", "onUpdate:value"])), {}, {
          "id": id,
          "dropdownClassName": props.popupClassName,
          "picker": "time",
          "mode": undefined,
...
export { Button as B, ConfigProvider as C, DatePicker$1 as D, Space as S, TimePicker$1 as T, localeValues$1 as a, api$1 as b, api as c, localeValues as l };
//# sourceMappingURL=zh_TW-DxTaLLT_.mjs.map
